          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <div className="flex gap-4">
                ...
                <a href={`https://github.com/${personalInfo.github}`} target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              <div className="flex gap-4">
                ...
                <a href={`https://github.com/${personalInfo.github}`} target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
                  ...
                  <a 
                    href="/cv.pdf" 
                    className="inline-block text-center px-4 py-2 bg-emerald-100 text-emerald-800 rounded-full hover:bg-white transition-colors"
                    download
                    onClick={toggleMenu}
                  >
                    TELECHARGEZ MON CV
